...
<head>
    ...
    <title>MacBook Pro 14 M3 Details</title>
                    ...
                    <table border="1" cellspacing="0" align="center" bgcolor="white" class="mtb product-details">
                        <tr>
                            <td class="product-image" align="center">
                                <img src="../../../assets/img/macbookpro.webp" alt="MacBook Pro 14 M3" height="300px" width="300px">
                                <h2>MacBook Pro 14 M3</h2>
                            </td>
                            <td class="description">
                                <h3>Product Description:</h3>
                                <p>The MacBook Pro 14 with M3 chip delivers extraordinary performance and efficiency. 
                                Features a stunning Liquid Retina XDR display and pro-level capabilities for demanding workflows.
                                <br><br>
                                <h4>Product Specifications:</h4>
                                <ul>
                                    <li>M3 chip with 10-core CPU</li>
                                ...
                                <form action="../../orders.php">
                                    <input type="hidden" name="product" value="MacBook Pro 14 M3">
