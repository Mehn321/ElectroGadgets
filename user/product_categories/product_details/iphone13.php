                    ...
                    <table border="1" cellspacing="0" align="center" bgcolor="white" class="mtb product-details">
                        <tr>
                            <td class="product-image" align="center">
                                <img src="../../../assets/img/iphone13.webp" alt="iPhone 13" height="300px" width="300px">
                                <h2>iPhone 13</h2>
                            </td>
                            <td class="description">
                                <h3>Product Description:</h3>
                                <p>The iPhone 13 features an advanced dual-camera system, A15 Bionic chip, and Super Retina XDR display. 
                                Experience exceptional performance and stunning photography capabilities.
                                <br><br>
