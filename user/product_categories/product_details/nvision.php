...
<head>
    ...
    <title>Nvision 32" Smart TV Details</title>
                    ...
                    <table border="1" cellspacing="0" align="center" bgcolor="white" class="mtb product-details">
                        <tr>
                            <td class="product-image" align="center">
                                <img src="../../../assets/img/nvision.webp" alt="Nvision 32 Smart TV" height="300px" width="300px">
                                <h2>Nvision 32" Smart TV</h2>
                            </td>
                            <td class="description">
                                <h3>Product Description:</h3>
                                <p>The Nvision 32" Smart TV offers excellent value with smart features and crisp HD display. 
                                Perfect for bedrooms and small living spaces.
                                <br><br>
                                <h4>Product Specifications:</h4>
                                <ul>
                                    <li>32-inch HD Display</li>
                                    <li>Android TV OS</li>
                                    <li>Built-in WiFi</li>
                                ...
                                <br>
                                <h2>Price: 9,999.99</h2>
                                <p>Stock: 50</p>
                                <form action="../../orders.php">
                                    <input type="hidden" name="product" value="Nvision 32 Smart TV">
