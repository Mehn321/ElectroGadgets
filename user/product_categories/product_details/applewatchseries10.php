                    ...
                    <table border="1" cellspacing="0" align="center" bgcolor="white" class="mtb product-details">
                        <tr>
                            ...
                            <td class="description">
                                ...
                                <p>The Apple Watch Series 10 represents the pinnacle of smartwatch technology. With advanced health monitoring, 
                                stunning always-on display, and powerful performance capabilities.
                                <br><br>
                                <h4>Product Specifications:</h4>
                                <ul>
                                    <li>Always-On Retina LTPO OLED display</li>
                                    <li>Blood Oxygen & ECG monitoring</li>
                                    <li>Advanced workout tracking</li>
                                    <li>Temperature sensing</li>
                                    <li>Crash Detection</li>
                                    <li>Up to 24 hours battery life</li>
                                    <li>S10 chip with 64-bit dual-core processor</li>
                                </ul>
                                </p>
                                <br>
                                <h2>Price: 25,999.99</h2>
                                <p>Stock: 20</p>
