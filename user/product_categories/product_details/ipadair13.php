...
<head>
    ...
    <title>iPad Air 13 Details</title>
                    ...
                    <table border="1" cellspacing="0" align="center" bgcolor="white" class="mtb product-details">
                        <tr>
                            <td class="product-image" align="center">
                                <img src="../../../assets/img/ipadair13inch.webp" alt="iPad Air 13" height="300px" width="300px">
                                <h2>iPad Air 13</h2>
                            </td>
                            <td class="description">
                                <h3>Product Description:</h3>
                                <p>The iPad Air 13 combines powerful performance with a stunning 13-inch display. 
                                Featuring the M2 chip and advanced features in a thin and light design.
                                <br><br>
                                ...
                                <br>
                                <h2>Price: 42,999.99</h2>
                                <p>Stock: 30</p>
                                <form action="../../orders.php">
                                    <input type="hidden" name="product" value="iPad Air 13">
