        ...
        <div class="rightside">
            ...
            <div class="main-content">
                <form action="" method="post">
                    ...
                    <div class="billing-form location-info">
                    ...
                    <div class="billing-section personal-info">
                    ...
                    <div class="button-group">
                        <button type="submit" class="blue-btn" onclick="window.location.href='delivery_date.php'">Submit</button>
